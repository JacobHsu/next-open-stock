    ...
    symbolsGroups: [
        ...
        },
        {
            ...
            symbols: [
                ...
                { name: 'NYSE:AUO', displayName: 'AUO - AU Optronics Corp' },
            ],
        },
        {
            name: 'Semiconductors',
            symbols: [
                { name: 'NASDAQ:ASML', displayName: 'ASML Holding' },
                { name: 'NASDAQ:QCOM', displayName: 'Qualcomm Inc' },
                { name: 'NASDAQ:AMAT', displayName: 'Applied Materials Inc' },
                { name: 'NASDAQ:INTC', displayName: 'Intel Corporation' },
                { name: 'NASDAQ:LRCX', displayName: 'Lam Research Corp' },
                { name: 'NASDAQ:KLAC', displayName: 'KLA Corporation' },
            ],
        },
        {
            ...
            symbols: [
                ...
                { name: 'NASDAQ:ADBE', displayName: 'Adobe Inc' },
                { name: 'NASDAQ:CSCO', displayName: 'Cisco Systems Inc' },
                { name: 'NASDAQ:PEP', displayName: 'PepsiCo Inc' },
            ],
        },
        {
            ...
            symbols: [
                ...
                { name: 'NASDAQ:GILD', displayName: 'Gilead Sciences Inc' },
                { name: 'NASDAQ:VRTX', displayName: 'Vertex Pharmaceuticals' },
                { name: 'NASDAQ:REGN', displayName: 'Regeneron Pharmaceuticals' },
                { name: 'NASDAQ:BIIB', displayName: 'Biogen Inc' },
            ],
        },
    ],
};
